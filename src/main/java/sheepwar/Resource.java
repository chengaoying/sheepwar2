...
public class Resource implements Common {
	...
	public static String propIntroduce [][]= {
		{"时光闹钟:#r时间静止10秒#r价格:","驱狼竖琴:#r清除成功逃脱的狼#r价格:"},//shopY
		{"捕狼网:#r发射一张大网网住灰太狼#r价格:","连发:#r使用后连续发射四颗飞镖,单关有效#r价格:"},
		{"防狼套装:#r使用后抵抗各种的攻击,持续30秒#r价格:","强力磁石:#r击落所有空中的灰太狼#r价格:"},
		{"激光枪:#r发射一道光波,持续5秒#r价格:","替身玩偶:#r增加一条命#r价格:"},
	};
