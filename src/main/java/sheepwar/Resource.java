...
public class Resource implements Common {
	...
	public static String gameInfo[] = {   
		...
		"【游戏简介】#r喜羊羊大战灰太狼是一款闯关类游戏，总共有15关。玩家控制喜羊羊击落一定数量的灰太狼即可过关。此外玩家还可以在道具商城内购买各种道具来获得更有趣的体验。",
		"",
	};
	
	/*商城商品介绍*/    	//二维数组创建注意
	public static String propIntroduce [][]= {
		{"时光闹钟:#r时间静止10秒#r价格:2","驱狼竖琴:#r清除成功逃脱的狼#r价格:3"},//shopY
		{"捕狼网:#r发射一张大网网住灰太狼#r价格:2","连发:#r使用后连续发射四颗飞镖,单关有效#r价格:3"},
		{"防狼套装:#r使用后抵抗各种的攻击,持续30秒#r价格:3","强力磁石:#r击落所有空中的灰太狼#r价格:5"},
		{"驱狼光波:#r发射一道光波,持续5秒#r价格:3","替身玩偶:#r增加一条命#r价格:5"},
	};
