...
public class StateShop implements Common{
	...
	private void showShop(SGraphics g) {
		...
		Image shop_go_pay_base = Resource.loadImage(Resource.id_achievement_left);				
		Image shop_go_pay_base1 = Resource.loadImage(Resource.id_achievement_left1);				
		...
		Image shop_stroke=Resource.loadImage(Resource.id_stroke);					
